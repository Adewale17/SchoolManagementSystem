                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('login') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" class="form-control" placeholder="username" id="username">
                                ...
                                <div class="mb-4 position-relative">
                                    ...
                                    <input type="password" name="password" id="dlabPassword" class="form-control" placeholder="Enter your password">
