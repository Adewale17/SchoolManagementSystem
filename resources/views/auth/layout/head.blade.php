...
<!-- Mirrored from edumin.dexignlab.com/laravel/demo/page-login by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Jul 2024 10:23:41 GMT -->
...
<head>
    ...
    <link class="main-css" href="{{ asset('public/css/style.css') }}" rel="stylesheet">

    <title>Laravel | Statistics</title>


    <link href="{{ asset('public/vendor/pickadate/themes/default.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('public/vendor/pickadate/themes/default.date.css')}}" rel="stylesheet" type="text/css" />
